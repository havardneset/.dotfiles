...
# Enable vi mode
bindkey -v
export KEYTIMEOUT=1  # Reduces delay when switching modes
...
# Initialize cursor as beam on startup
echo -ne '\e[5 q'

# Use beam cursor shape on zsh startup and after every command
